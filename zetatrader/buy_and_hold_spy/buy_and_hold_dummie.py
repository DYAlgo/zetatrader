...
class BuyAndHoldDummie(AbstractStrategy):
    """
    This strategy simply goes long on a security from 
    the when no position is established and sells it evert 
    100th market bar event.
