...
# Updates NYSE daily price table from Tiingo
# Created: Darren Yeap
...
def update_nyse_daily_price(db_handler, tiingo_handler):
    '''Creates a symbol_table_handler object and calls
    the function needed to update daily price for NYSE
    securities
    '''
    # Create the obj
    ...
    pt_handler.update_nyse_daily_price(source='Tiingo')

if __name__ == "__main__":
    update_nyse_daily_price(SecDbDataHandler, Tiingo)